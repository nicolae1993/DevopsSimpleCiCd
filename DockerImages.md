...
```This Docker image was built automatically using a Jenkins pipeline. The pipeline handles building the image from the Dockerfile and tagging it with both a unique build version and latest for easy deployment.```
